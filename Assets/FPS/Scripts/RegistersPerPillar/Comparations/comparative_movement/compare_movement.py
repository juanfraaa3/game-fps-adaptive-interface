...
file_path = "comparative_movement.xlsx"

BASE_OUTPUT_DIR = r"C:\Users\Juanes\adaptative_microgame\Assets\FPS\Scripts\RegistersPerPillar\Comparations\comparative_movement"
...
GROUPS = {
    "Movement_noobs": "_noob",
    "Movement_regulars": "_regular",
    "Movement_experts": "_expert",
    "Movement_all": None
}
...
print("\nAnalisis MOVEMENT completo guardado por carpetas.")